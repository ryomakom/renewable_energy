...
デジタル版は[こちら](https://digital.asahi.com/articles/ASS296K84S10TIPE026.html)。

電力各社が公表しているデータをどう加工して集計したかを、以下で説明する。
...
あと、会社ごとにファイルがひとつにまとまっておらず、月ごとだったり四半期ごとだったりにバラバラになっているのも難点。それからファイル冒頭の但し書きとか、列の並び方とか、時刻の表記方法とかが会社ごとにちょっとずつ違うので、これを共通の形式に書き換えてまとめるのが一苦労。たぶん3時間くらいの作業だった。
